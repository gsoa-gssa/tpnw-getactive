...
<body>
    ...
    <p>Du hast dich für den Event «{{$event->getTranslatable("name", $language)}}» angemeldet, der morgen stattfindet. <b>Danke dafür!</b></p>
    ...
    @if ($signup->additional_information)
        <p><b>Zusätzliche Informationen zu deiner Anmeldung:</b></p>{!!$signup->additional_information!!}
    @endif
